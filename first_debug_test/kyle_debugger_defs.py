...
WORD = c_ushort
DWORD = c_ulong
DWORD64 = c_ulonglong  # added for x64 struct compatibility - double c_ulong size
...
# Begin x64 backward compatibility defs - added by Kyle
...
# Register data returned from thread needs to be in format Rxx instead of Exx (i.e ESP will be RSP) for 32 bit app on
# 64 bit platform
